<script lang="ts">
  ...
  /** Tarjeta del selector: los formatos que se diligencian en su propia ruta
   *  traen `ruta` y solo navegan; los demás se abren aquí mismo. */
  function abrirTarjeta(f: FormularioResumen) {
    if (f.ruta) {
      goto(f.ruta)
      return
    }
    seleccionarTipo(f.tipo)
  }
        ...
        {#each data.formularios as f}
          ...
          >
            <div class="card-icon">
              ...
              {:else if f.tipo === 'declaracion_empresa_transporte'}
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-9.026 0A1.106 1.106 0 003.25 6.615v9.01c0 .568.422 1.048.987 1.106M14.25 6.573V18.75m0 0H9.75" />
                </svg>
              {:else}
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
            ...
            <div class="card-content">
              ...
              <p>
                ...
                {:else if f.tipo === 'declaracion_empresa_transporte'}
                  Empresas de transporte tercerizadas. Declaran el control de vehículos,
                  propietarios y conductores que vinculan al servicio.
                {:else}
